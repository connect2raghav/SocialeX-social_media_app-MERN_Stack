...
const SocketHandler = (socket) => {
    ...
    socket.on('updateProfile', async ({userId, profilePic, username, about, mood})=>{
        const user = await User.updateOne({_id: userId}, {profilePic: profilePic, username: username, about:about, mood: mood})
        socket.emit("profile-fetched", {profile: user})
    })
