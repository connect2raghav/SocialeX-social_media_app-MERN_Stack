...
const [updateProfileMood, setUpdateProfileMood] = useState('');
...
const [isUpdating, setIsUpdating] = useState(false);
  ...
  useEffect(()=>{
    ...
    socket.on("profile-fetched", async({profile})=>{
      ...
      setUpdateProfileMood(profile.mood || '😊 Happy');
    })
  ...
  const handleUpdate = async () =>{
    socket.emit('updateProfile', {userId: userProfile._id, profilePic: updateProfilePic, username: updateProfileUsername, about: updateProfileAbout, mood: updateProfileMood});
    setIsUpdating(false);
  }
    ...
    <div className='profilePage'>
      ...
      <Navbar />
        ...
        <div className="profileCard" style={isUpdating ? {display:'none'}: {display:"flex"}}>
            ...
            <p className="mood">{userProfile.mood || '😊 Happy'}</p>
        ...
        <div className='profileEditCard'style={!isUpdating ? {display:'none'}: {display:"flex"}}>
          ...
          <div class="mb-3">
            ...
            <select class="form-control" id="editMood" onChange={(e)=> setUpdateProfileMood(e.target.value)} value={updateProfileMood}>
